...
30. Run campaign motion nodes one at a time. Do not batch motion launches. After each motion click, wait for Active Runs acknowledgement or refreshed completion before selecting the next motion node.
